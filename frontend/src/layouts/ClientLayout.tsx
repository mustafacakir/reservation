...
import { CalendarDays, LogOut, Menu, X, UserCog, GraduationCap, MessageCircle } from 'lucide-react'

const navItems = [
  { to: '/client/bookings',  label: 'Derslerim', Icon: CalendarDays },
  { to: '/client/messages',  label: 'Mesajlar',  Icon: MessageCircle, badge: true },
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-30 h-14 bg-white border-b border-gray-100 flex items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          <Link to="/client/messages" className="relative p-1.5 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors">
